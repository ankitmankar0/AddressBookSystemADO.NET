...
DELETE FROM AddressBookSystem WHERE FirstName='Shubham';

--insert record into table
insert into AddressBookSystem values('Ankit','Mankar','Wadi','Nagpur','MH','440023','8888888888','aron@gmail.com','Family','FamilyBook');
select * from AddressBookSystem;
